...
int main(int argc, char* argv[]) {
    ...
    cin >> block_size;
    cout << "Enter the number of bits for characters for RLE: ";
    cin >> ms;
    cout << "Enter the number of bits to store repetitions in RLE: ";
    cin >> mc;
    ...
    decode = rle.decode(decode, ms, mc);
    decode = mtf.decode(decode, 1);
